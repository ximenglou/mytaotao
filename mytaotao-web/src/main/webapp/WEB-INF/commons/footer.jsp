...
<script type="text/javascript" src="${mytaotaoStaticURL}/js/jquery-extend.js"></script>
<script type="text/javascript" src="${mytaotaoStaticURL}/js/lib-v1.js" charset="utf-8"></script>
