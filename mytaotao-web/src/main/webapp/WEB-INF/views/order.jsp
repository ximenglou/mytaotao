...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${mytaotaoStaticURL}/js/jquery.checkout.js"></script>
	<script type="text/javascript" src="${mytaotaoStaticURL}/js/base-v1.js"></script>
	<script type="text/javascript" src="${mytaotaoStaticURL}/js/order.common.js"></script>
	<script type="text/javascript" src="${mytaotaoStaticURL}/js/taotao.js" charset="utf-8"></script>
</head>
<body id="mainframe">
<!--shortcut start-->
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	<script type="text/javascript" src="${mytaotaoStaticURL}/js/order.js"></script>
	<script type="text/javascript" src="${mytaotaoStaticURL}/js/base-2011.js"></script>
    <script type="text/javascript" src="${mytaotaoStaticURL}/js/lib-v1.js"></script>
    <script type="text/javascript" src="${mytaotaoStaticURL}/js/jTips.js"></script>
    <script type="text/javascript" src="${mytaotaoStaticURL}/js/calendar.js"></script>
