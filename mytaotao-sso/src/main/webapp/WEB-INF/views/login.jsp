...
<%
    pageContext.setAttribute("mytaotaoStaticURL","http://static.mytaotao.com");
%>
...
<head>
    ...
    <title>登录淘淘</title>
    <link type="text/css" rel="stylesheet" href="${mytaotaoStaticURL}/css/login.css"/>
    <script type="text/javascript" src="${mytaotaoStaticURL}/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="${mytaotaoStaticURL}/js/login/g.base.js"></script>
   	<script type="text/javascript" src="${mytaotaoStaticURL}/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
    	<a href="http://sso.mytaotao.com/" clstag="passport|keycount|login|01">
    		<img src="${mytaotaoStaticURL}/images/taotao-logo.gif" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(${mytaotaoStaticURL}/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;">
			</div>
            <div class="form ">
                ...
                <div class="item fore4 hide" id="autoentry">
                    <div class="item-ifo">
                        ...
                        <label class="mar">自动登录</label>
                            ...
                            <input type="checkbox" class="checkbox" id="chkOpenCtrl" name="chkOpenCtrl" onclick="inputSelect();"/>
        ...
        <div class="free-regist">
            <span><a href="http://sso.mytaotao.com/user/register.html" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
...
<script type="text/javascript" src="${mytaotaoStaticURL}/js/login/login.js"></script>
<script type="text/javascript" src="${mytaotaoStaticURL}/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="${mytaotaoStaticURL}/js/login/checkClient.js"></script>
<script>
